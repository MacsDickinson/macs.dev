...
//
// This module lives apart from `content.ts` on purpose: it embeds the full
// text of every post, so it must only ever be imported from lazy-loaded
// code (Writing, BlogPost) — never from anything in the main chunk.
